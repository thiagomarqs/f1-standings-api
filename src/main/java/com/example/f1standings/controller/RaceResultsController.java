...
@RestController
@RequestMapping("/api/results/races")
public class RaceResultsController {
    ...
    @GetMapping
    public ResponseEntity<List<RaceResult>> getStandings() throws IOException {
        List<RaceResult> raceResults = raceResultsService.getStandings();
